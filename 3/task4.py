...
for i in range(10):
    ...
    accuracy_linear[i] = accuracy_linear[i]/10.0
    accuracy_rf[i] = accuracy_rf[i]/10.0
'''
for i in range(10):
...
'''
print("####################")
print("The RMSE (Root-Mean-Squared-Error) of 10-rerun of 10-fold-cross-validation of 2 models:")
for i in range(10):
...
print("####################")
print("sign-test:")
print("LinearModel_win", ": ", Awin)
print("RandomForest_win", ": ", Bwin)
if Bwin >= 8:
    print("At the critical level of 0.05(one-tailed) We can reject the zero hypothesis that P(LinearModel_win > RandomForest_win) = 0.5 and get the conclusion that the random forest performs better than the linear model.")
else:
    print("At the critical level of 0.05(one-tailed) We cannot reject the zero hypothesis that P(LinearModel_win > RandomForest_win) = 0.5.")
